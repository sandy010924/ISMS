...
(function(d) {
    ...
    d.extend(n.prototype, {
                ...
                if (r)
                    if (d.isArray(r)) this._expandButton(a, r, c, e);
                        ...
                        l &&
                            ...
                            r.init &&
                                r.init.call(g.button(l.node), g, d(l.node), r),
                            f++);
                    }
            }
        },
        ...
        _popover: function(a, b, c) {
            ...
            "dt-container" === g.align &&
                ((f = f.parent()), c.css("width", k.width()));
            if ("absolute" === e) {
                e = f.position();
                ...
                (c.hasClass(g.rightAlignClassName) ||
                    "button-right" === g.align) &&
                    c.css("left", e.left + f.outerWidth() - l);
                r = e.left + l;
    ...
    n.instanceSelector = function(a, b) {
        ...
        var c = [],
            ...
            g = function(a) {
                if (d.isArray(a))
                    for (var f = 0, k = a.length; f < k; f++) g(a[f]);
                else
                    "string" === typeof a
                        ? -1 !== a.indexOf(",")
                            ? g(a.split(","))
                ...
                g = function(a, b) {
                    ...
                    if (d.isArray(a) || a instanceof d)
                        ...
                        for (k = 0, f = h.length; k < f; k++)
                            c.push({ inst: b, node: h[k].node });
                    else if ("number" === typeof a)
                        c.push({ inst: b, node: b.s.buttons[a].node });
                    else if ("string" === typeof a)
                        if (-1 !== a.indexOf(","))
                            for (
                                h = a.split(","), k = 0, f = h.length;
                                k < f;
                                k++
                            )
                                g(d.trim(h[k]), b);
                            ...
                            for (
                                a = a.replace(":name", ""), k = 0, f = h.length;
                                k < f;
                                k++
                            )
                                h[k].name === a &&
    ...
    m.Api.register("buttons()", function(a, b) {
        ...
        var c = this.iterator(
            ...
            function(c) {
                if (c._buttons)
                    return n.buttonSelector(
                        n.instanceSelector(a, c._buttons),
                        b
                    );
            },
            !0
    ...
    m.Api.registerPlural("buttons().active()", "button().active()", function(
        a
    ) {
        return a === p
            ? this.map(function(a) {
    ...
    m.Api.registerPlural("buttons().action()", "button().action()", function(
        a
    ) {
        return a === p
            ? this.map(function(a) {
